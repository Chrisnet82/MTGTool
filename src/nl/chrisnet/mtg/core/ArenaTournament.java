...
public class ArenaTournament {
	...
	/**
	 * Set x points to given player. Needs to be between -2 and plus 3.
	 * @param player
	 * @param points
	 * @throws ArenaException 
	 */
	public void setPointsToPlayer(String player, String points) throws ArenaException {
		try {
			int punten = Integer.parseInt(points);
			...
			throw new ArenaException("Please enter a whole number");
		}
	}
